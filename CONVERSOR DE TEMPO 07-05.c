            ...
            scanf(" %c", &escolha);
                switch (escolha)
                {
                    case '1':
                        ...
                        if (escolha2 == 1){
                        resultado = tempo * 60;
                                printf("%.0f Horas eh igual a -> %.2f Minutos :)! ", tempo, resultado);
                                }
                        else if (escolha2 == 2){
                            resultado = (tempo * 60) * 60;
                                printf("%.0f Horas eh igual a -> %.2f Segundos :)! ", tempo, resultado);
                    ...
                    case '2':
                        ...
                        if (escolha2 == 1){
                        resultado = tempo / 60;
                                printf("%.0f Minutos eh igual a -> %.2f Horas :)! ", tempo, resultado);
                                }
                        else if (escolha2 == 2){
                            resultado = tempo * 60;
                                printf("%.0f Minutos eh igual a -> %.2f Segundos :)! ", tempo, resultado);
                                }
                            break;
                    ...
                    case '3':
                        ...
                        if (escolha2 == 1){
                            resultado = tempo / 60;
                                printf("%.0f Segundos eh igual a -> %.2f Minutos :)! ", tempo, resultado);
                                }
                        else if (escolha2 == 2){
                            resultado = (tempo / 60) / 60;
                                printf("%.0f Segundos eh igual a -> %.2f Horas :)! ", tempo, resultado);
                                } 
                            break;
